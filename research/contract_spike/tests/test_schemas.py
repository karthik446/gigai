...
def valid_instances() -> dict[str, dict[str, Any]]:
    ...
    improvement_manifest = {
        ...
        "quality_gate": {
            ...
            "development": {"case_count": 4, "bar_pass": True, "metrics": {"recall": 1}},
            "calibration": {"case_count": 2, "bar_pass": True, "metrics": {"recall": 1}},
            "final_holdout": {"case_count": 2, "bar_pass": True, "metrics": {"recall": 1}},
