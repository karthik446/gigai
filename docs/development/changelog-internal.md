...
- Phase 2: G22
- Phase 4: G19
- Phase 5: G20 and G21 complete; G23 active under its accepted amendment
...
- Roadmap gate: G00–G21 and G22 are represented as complete; G23 is active
  under its accepted additive amendment.
...
- G20: complete; its learning records, improvement manifest, two gates, recovery,
  ...
  G23: additive amendment accepted; runtime implementation is in progress.
...
- Current closeout: G21 completion audit and terminal handoff are accepted;
  G23 is the independent active prerequisite before G24.
...
Goal contract and additive amendment accepted; runtime implementation active. See the [G23 goal contract](goals/phase-5/G23-gig-self-containment-and-portability.md)
...
Implementation evidence will be recorded under the G23 evidence directory as
milestones land. G23 is independent of G21 and does not
