...
mutation harness covers five named guards, and the recovery test reconciles an
interrupted journal transaction before exposing the manifest as durable
evidence. Broader evaluator coverage and G29 human UAT remain open.
