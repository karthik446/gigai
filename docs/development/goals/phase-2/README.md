...
|---|---|---|---|
| [G22](G22-deliberative-create-and-proposal-interview.md) | Local deliberative `create` and approved proposal interview | S22-01, proposal-interview amendment, G18 | Complete |
