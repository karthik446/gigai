...
protocol. G18 supplies the explicit model-invocation and provider boundary.
...
|---|---|---|---|
| [G22](G22-deliberative-create-and-proposal-interview.md) | Local deliberative `create` and approved proposal interview | S22-01, G18 | Proposed for review |
...
authority rule not represented by the accepted 21-resource contract, G22 stops
