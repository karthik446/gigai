...
from gigai.scout_posting_inputs import resolve_discovery_posting_input_from_journal
from gigai.cli import cli
from gigai.run import read_run_details
from tests.test_scout02_graph_set_flow import _write_definition
from tests.test_scout06_research_inputs import _complete as complete_research
...
def test_interview_accepts_actual_saved_research_revision_snapshot(tmp_path: Path):
    ...
    from gigai.scout_research_inputs import resolve_research_input_from_journal
...
def test_public_revision_race_refuses_competing_parent_without_second_commit(tmp_path: Path, monkeypatch: pytest.MonkeyPatch):
    import gigai.scout_interview_records as records
