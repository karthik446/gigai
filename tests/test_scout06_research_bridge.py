...
from gigai.scout_research import (
    DOMAIN_SCHEMA_ID,
...
def _packet(*, inputs: list[dict[str, object]] | None = None):
    renderer = import_module(
        "gigai.data.scout.tools.cap_00000000-0000-4000-8000-000000000071.research"
    )
...
def test_fixed_bridge_accepts_exact_role_only_packet_and_exposes_fixed_resources() -> None:
    ...
    assert FIXED_DOMAIN_RESOURCES == {
        ...
        "schema_resource": "data/scout/tools/cap_00000000-0000-4000-8000-000000000071/research.schema.json",
        "validator_id": VALIDATOR_ID,
        "validator_source": "gigai.scout_research:validate_research_domain",
    }
