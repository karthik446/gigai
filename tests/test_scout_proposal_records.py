...
from gigai.scout_proposal_execution import execute_local_proposal
from gigai.scout_proposal_records import (
...
from tests.test_scout_proposal_execution import _Transport, _config, _setup_inputs
