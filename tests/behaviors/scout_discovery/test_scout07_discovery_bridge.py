...
from gigai.scout.discovery import ScoutDiscoveryError, validate_discovery_domain
from tests.behaviors.scout_discovery.test_scout07_discovery_packet import _build, _fixture, _optional_inputs
...
def _case():
    ...
    renderer = import_module(
        "gigai.scout.data.tools.cap_00000000-0000-4000-8000-000000000074.discovery"
    )
