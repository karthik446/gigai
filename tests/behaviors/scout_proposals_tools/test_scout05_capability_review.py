...
from tests.behaviors.scout_proposals_tools.test_scout05_bundled_tools import (
    _candidate,
    _prepared_manifest,
)
from gigai.scout.bundled_tools import SCOUT_CRUD_CAPABILITY_ID, SCOUT_CRUD_MANIFEST_ID
