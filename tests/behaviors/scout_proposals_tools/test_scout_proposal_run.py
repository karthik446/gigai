...
from tests.behaviors.scout_proposals_tools.test_scout03_native_records import _experience, _profile
...
def test_competing_cancel_preserves_invocation_evidence_without_goal_terminal_duplication(
    ...
    import gigai.scout.proposal_execution as proposal_module
