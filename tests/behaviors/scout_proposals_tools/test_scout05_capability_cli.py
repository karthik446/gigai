...
from gigai.scout.bundled_tools import SCOUT_CRUD_CAPABILITY_ID, SCOUT_CRUD_ENTRY_PATH, SCOUT_CRUD_MANIFEST_ID
...
def test_cli_passes_actual_reviewer_and_distinct_local_operator_then_replays(tmp_path: Path) -> None:
    ...
    assert "gigai.scout.tool_adapter" not in sys.modules
