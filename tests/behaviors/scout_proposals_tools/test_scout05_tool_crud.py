...
from gigai.scout.tools import ScoutToolError, dispatch_native_record_tool
...
from tests.behaviors.scout_proposals_tools.test_scout03_c3_tools import _CAPABILITY, _MANIFEST, _manifest
...
_WRAPPER = _REPO / "src/gigai/scout/data/gig.py"
...
def _crud_inventory(workpad: Path) -> list[dict[str, object]]:
    ...
    source = b'''from gigai.scout.tool_adapter import (\
