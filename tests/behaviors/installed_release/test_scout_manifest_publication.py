...
from gigai.scout.bundled_tools import SCOUT_CRUD_MANIFEST_ID

from tests.behaviors.scout_proposals_tools.test_scout05_bundled_tools import _candidate
from tests.behaviors.scout_proposals_tools.test_scout05_capability_review import _fixture, _review_kwargs
