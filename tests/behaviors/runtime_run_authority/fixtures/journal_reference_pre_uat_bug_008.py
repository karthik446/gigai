# Frozen reference: byte-exact pre-uat-bug-008 gigai/journal.py.
# Source commit: 78fcbf2^ = 0da8fc4 (test(scout): API end-to-end suite over HTTP, make api-e2e (test-gap-001)).
# Frozen reference for the equivalence test; never edit.
...
TRANSITIONS = frozenset(
    {
        ...
        "gig_discovery_manifest_written",
        "proposal_interview_blocked",
        "proposal_interview_approved",
        "gig_builder_researching",
        "gig_builder_draft_ready",
        "gig_builder_failed",
        "gig_builder_approved",
        "gig_builder_revised",
