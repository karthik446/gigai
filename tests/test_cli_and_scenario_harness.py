...
def test_installed_help_version_and_goal_approved_commands_are_the_only_surface(
    ...
    assert (
            "Choose 'setup', 'doctor', 'init', 'create', 'improve', 'feedback', 'revise', 'approve', 'reject', 'gigs', 'proposals', 'status', 'show', 'history', 'plan', 'run', 'run-details', 'occurrence', 'workpad', 'check', or 'open'"
