...
from gigai.scout_acquisition_records import (
...
from tests.test_scout03_native_records import _options
...
def test_copied_wrapper_uses_shared_rows_loader_for_redirects(tmp_path: Path, final_symlink: bool) -> None:
    ...
    shutil.copyfile(Path(__file__).parents[1] / "src/gigai/data/scout/gig.py", wrapper)
