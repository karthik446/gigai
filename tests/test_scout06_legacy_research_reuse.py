...
from gigai import external_recording, scout_materialization
...
def _legacy_source() -> dict[str, bytes]:
    ...
    package = resources.files("gigai.data").joinpath(
        "scout", "tools", "cap_00000000-0000-4000-8000-000000000071"
    )
...
def test_completed_legacy_v2_research_reuses_through_v3_successor(
    ...
    legacy_checkpoint, legacy_receipt = _complete_research(
        ...
        renderer_module="gigai.data.scout.tools.cap_00000000-0000-4000-8000-000000000071.research",
        schema_id="urn:gigai:scout:research-packet:2",
        key="legacy-v2",
    )
    ...
    v3_checkpoint, v3_receipt = _complete_research(
        ...
        run=v3_run.payload,
        renderer_module="gigai.data.scout.tools.cap_00000000-0000-4000-8000-000000000076.research",
        schema_id="urn:gigai:scout:research-packet:3",
        key="v3-reuse",
    )
