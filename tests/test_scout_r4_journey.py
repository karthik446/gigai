...
from gigai.scout_document_records import read_document_revision, read_final_selection
from gigai.scout_documents import FinalDocumentSelection
from gigai.scout_projection import rebuild_projection, query_projection
from gigai.scout_report import publish_report, read_current_report
from gigai.scout_report_readers import default_reader_set, opportunity_reader
from gigai.scout_proposal_records import read_proposal_revision
...
from tests.test_scout_proposal_run import _consent, _request_inputs
from tests.test_scout03_native_records import _experience
...
def test_r4_full_tailor_report_application_journey(
    ...
    changed_profile = __import__("tests.test_scout03_native_records", fromlist=["_profile"])._profile()
