...
_VALIDATOR_SOURCE = "gigai.scout_research:validate_research_domain"
_SCHEMA_RESOURCE = (
...
_V3_VALIDATOR_SOURCE = "gigai.scout_research_v3:validate_research_domain"
_V3_SCHEMA_RESOURCE = (
    "data/scout/tools/cap_00000000-0000-4000-8000-000000000076/research.schema.json"
)
...
def _fixed_domain_binding(
    ...
    versions = {
        (_DOMAIN_SCHEMA_ID, _VALIDATOR_ID): (_SCHEMA_RESOURCE, "gigai.scout_research", "validate_research_domain"),
        (_V3_DOMAIN_SCHEMA_ID, _V3_VALIDATOR_ID): (_V3_SCHEMA_RESOURCE, "gigai.scout_research_v3", "validate_research_domain"),
    }
