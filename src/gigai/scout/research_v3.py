...
SCHEMA_RESOURCE = (
    "scout/data/tools/cap_00000000-0000-4000-8000-000000000076/"
    "research.schema.json"
)
VALIDATOR_SOURCE = "gigai.scout.research_v3:validate_research_domain"
...
_RENDERER_MODULE = (
    "gigai.scout.data.tools.cap_00000000-0000-4000-8000-000000000076.research"
)
...
def _validate_historical_packet_integrity(
    *,
    ...
    if schema_id == DOMAIN_SCHEMA_ID:
        ...
        from .research import validate_research_domain as validate_prior
    else:
