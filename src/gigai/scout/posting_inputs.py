...
from .template import SCOUT_DISCOVERY_SCHEMA_PATH, SCOUT_DISCOVERY_SOURCE_PATH
...
_VALIDATOR_SOURCE = "gigai.scout.discovery:validate_discovery_domain"
_SCHEMA_RESOURCE = "scout/data/tools/cap_00000000-0000-4000-8000-000000000074/discovery.schema.json"
_SOURCE_RESOURCE = "scout/data/tools/cap_00000000-0000-4000-8000-000000000074/discovery.py"
...
def _domain_binding(snapshot: JournalSnapshot, plan: Mapping[str, object]) -> dict[str, object]:
    ...
    try:
        ...
        from .discovery import validate_discovery_domain
