...
def _run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if args.command == "acquisition":
        from gigai.scout_acquisition_records import import_public_rows, read_public_acquisition_status, resume_public_acquisition

        if args.acquisition_operation == "import":
            try:
                from gigai.scout_acquisition_records import read_public_rows_file
    ...
    if args.command == "interview":
        from gigai.scout_interview_records import (
    ...
    if args.command == "final-select":
        ...
        from gigai.scout_document_records import read_document_revision, read_final_selection, record_final_selection
    ...
    if args.command in {"create", "update", "archive"}:
        ...
        from gigai.scout_tools import invoke_approved_tool_entry
